...
<div class="container col-lg-6">
    <h1 style="color: #f1ff20">NID Information</h1>
    <div class="card">
        <div class="card-body">
            <form method="post"
                  class="form-group"
                ...
                <!-- Date of Birth -->
                <div class="form-group">
                    <label for="dob" style="color: floralwhite">Date of Birth</label>
                    <input type="date"
                           name="dob"
                           id="dob"
                           value="${dto.dob}"
                ...
                <!-- NID Number -->
                <div class="form-group">
                    <label for="nidNumber" style="color: floralwhite">NID Number</label>
                    <input type="text"
                           name="nidNumber"
                           id="nidNumber"
                           value="${dto.nidNumber}"
